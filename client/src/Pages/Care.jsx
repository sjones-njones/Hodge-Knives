const Care = () => {
  ...
  return (
    <div>
      ...
      <div className='mx-auto text-start w-75 card bg-black'>
        ...
        <h3 className='my-4 fw-bold text-white'>2. Don’t store your knives in the utensil drawer.</h3>
        <h4 className="text-white fw-light">
        ...
        <h4 className="text-white fw-light">
          It’s like a tune-up for the knife. There are many ways to do this: using a honing steel, a knife stone, or even send it out to a me!
        </h4>
        <h3 className='my-4 fw-bold text-white'>
        6. Always cut on cutting boards.</h3>
        <h4 className="text-white fw-light">
